		...
		new Thread() {
			public void run() {
				try {
					...
					UIUtils.showToast(SplashActivity.this, "111");
					enterHome();
				} catch (NotFoundException e) {
					e.printStackTrace();
					UIUtils.showToast(SplashActivity.this, "112");
					enterHome();
				} catch (IOException e) {
					e.printStackTrace();
					UIUtils.showToast(SplashActivity.this, "113");
					enterHome();
				} catch (JSONException e) {
					e.printStackTrace();
					UIUtils.showToast(SplashActivity.this, "114");
					enterHome();
				} finally {
		...
		dialog.setPositiveButton("呵呵", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				// sdk不存在
					...
					UIUtils.showToast(SplashActivity.this, "请检查sdk是否插好，检测不到sd卡");
					return;
				}
			}
		});
